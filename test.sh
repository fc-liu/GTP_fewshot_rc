...
for N in 5 10;do
    for K in 1 5;do
        ...
        for seed in 1 12 123 1234 12345;do
            ...
            CUDA_VISIBLE_DEVICES=7 python test.py --N $N --K $K --bert_model /share/model/bert/cased_L-24_H-1024_A-16 --ckpt_name three-less-nointer-l2-h4 --abla nointer --layer 2 --n_head 4 --model_name proto_three --paral_cuda 0 > data/res.json
